...
!! BRAD 2023-01-06:
integer(8) :: micro_move_speed = 4 ! How many times slower than normal should micro-unbound tPA move?
integer(8) :: total_regular_moves
integer(8) :: total_restricted_moves
integer(8) :: total_skipped_moves
...
if (micro_move_speed.ne.1) then
    write(*,*)' Micro-unbound molecule move speed reduced by a factor of ',micro_move_speed
end if
...
!! BRAD 2023-11-24:
                                ! Slow micro-unbinding movement speed by a factor of micro_move_speed
                                if (t_wait(j).lt.t.or.mod(count,micro_move_speed).eq.0) then
...
!! BRAD 2023-11-24:
                                    ...
                                    total_skipped_moves = total_skipped_moves + 1
                                end if
...
!! BRAD 2023-01-06:
        ...
        write(*,*)'Total Skipped Moves: ',total_skipped_moves
