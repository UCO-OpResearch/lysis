...
#. **Start a new feature** (Task #1, #5, etc.)
...
#. **Work on something that might take multiple sessions**
...
#. **Feature is complete** (passes your own testing)
#. **Code works** (doesn't break existing functionality)
#. **Ready to move on** (don't leave stale branches)
