...
implicit none
character(15)      :: runCode = '2023-01-31-1302'
...
integer,parameter  :: simulations= 1 !! BRAD 2023-01-04: 10
...
integer, dimension(simulations)             :: Nsavevect 
integer                              :: name1, name2
...
integer, dimension(N,simulations)  :: lastmove
integer  :: fdeg
integer  :: first0
...
integer, dimension(simulations,tf)  :: countbindV, countindepV, bind1V
...
write(*,*)' num=',num
write(*,*)' M=',M
write(*,*)' obtained using code macro_rng_array.f90 on data ',runCode
...
!        open(m_tracker_unit,file=ADJUSTL('data/' // runCode // '/m_tracker' // outFileCode),form=filetype)
!    open(deg_tracker_unit,file=ADJUSTL('data/' // runCode // '/deg_tracker' // outFileCode),form=filetype)
...
!            if(count<=100) then
!                write(random_file,'(A,I0.3,A)') 'data/' // runCode // '/random', count, outFileCode
