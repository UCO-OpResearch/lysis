...
character(60)   :: outFileCode = '_PLG2_tPA01_Kd00020036_always_Q2.dat'
...
double precision, parameter :: avgwait = 277.8!1/0.036 !2.78 !27.8 !measured in seconds, this is the average time a tPA molecule stays bound to fibrin. It's 1/koff. For now I'm using 27.8 to be 1/0.036, the value in the absence of PLG
...
integer  :: seed=1299539472!9965734
