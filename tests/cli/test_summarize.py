"""Tests for ``lysis summarize`` CLI command."""
...
class TestMdTable:
    def test_header_row(self):
        from lysis.cli.summarize import _md_table
...
class TestSummarizeToMarkdown:
    def test_single_file_heading(self, mock_stats):
        from lysis.cli.summarize import _summarize_to_markdown
...
class TestSummarizeMarkdownSingleFile:
    @patch("lysis.cli.summarize._load_run_stats")
    def test_markdown_to_stdout(self, mock_load, runner, mock_stats, tmp_path):
        ...
        result = runner.invoke(cli, ["summarize", str(h5), "--markdown", "-"])
    ...
    def test_markdown_to_file(self, mock_load, runner, mock_stats, tmp_path):
        ...
        result = runner.invoke(
            cli, ["summarize", str(h5), "--markdown", str(out_file)]
        )
    ...
    def test_markdown_file_content(self, mock_load, runner, mock_stats, tmp_path):
        ...
        runner.invoke(cli, ["summarize", str(h5), "--markdown", str(out_file)])
    ...
    def test_no_markdown_flag_gives_normal_output(self, mock_load, runner, mock_stats, tmp_path):
        ...
        result = runner.invoke(cli, ["summarize", str(h5), "--no-progress"])
...
class TestSummarizeMarkdownDirectory:
    ...
    def test_markdown_to_stdout(self, mock_load, runner, mock_stats, tmp_path):
        ...
        result = runner.invoke(
            cli, ["summarize", str(tmp_path), "--markdown", "-"]
        )
    ...
    def test_markdown_to_file(self, mock_load, runner, mock_stats, tmp_path):
        ...
        result = runner.invoke(
            cli, ["summarize", str(tmp_path), "--markdown", str(out_file)]
        )
    ...
    def test_no_markdown_gives_no_pipe_chars_as_headings(
        ...
        result = runner.invoke(
            cli, ["summarize", str(tmp_path), "--no-progress"]
        )
